...
import { SteamKeyFindManyArgs } from "../../steamKey/base/SteamKeyFindManyArgs";
import { SteamKey } from "../../steamKey/base/SteamKey";
...
export class OrderControllerBase {
  ...
  async findSteamKeys(
    ...
    const query = plainToClass(SteamKeyFindManyArgs, request.query);
    const results = await this.service.findSteamKeys(params.id, {
      ...query,
      select: {
        activated: true,
        createdAt: true,
  ...
  @common.Post("/:id/steamKeys")
  @nestAccessControl.UseRoles({
    resource: "Order",
    action: "update",
    possession: "any",
  })
  async connectSteamKeys(
    @common.Param() params: OrderWhereUniqueInput,
    @common.Body() body: SteamKeyWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      steamKeys: {
        connect: body,
  ...
  @common.Patch("/:id/steamKeys")
  @nestAccessControl.UseRoles({
    resource: "Order",
    action: "update",
    possession: "any",
  })
  async updateSteamKeys(
    @common.Param() params: OrderWhereUniqueInput,
    @common.Body() body: SteamKeyWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/steamKeys")
  @nestAccessControl.UseRoles({
    resource: "Order",
    action: "update",
    possession: "any",
  })
  async disconnectSteamKeys(
    @common.Param() params: OrderWhereUniqueInput,
    @common.Body() body: SteamKeyWhereUniqueInput[]
  ): Promise<void> {
    const data = {
